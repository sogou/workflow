...
static inline void slist_add_after(struct slist_node *node, struct slist_node *prev,
...
static inline void __slist_splice(struct slist_head *list, struct slist_node *at,
...
static inline void slist_splice_init(struct slist_head *list, struct slist_node *at,
				     struct slist_head *head)
{
	if (!slist_empty(list))
	{
