...
#if defined(__i386__) || (defined(__arm__) && !defined(__ARMEB__)) || defined(__sh__) || \
	defined(__bfin__) || defined(__MIPSEL__) || defined(__cris__) ||                 \
...
/* big endian, 32 bits */
#elif defined(__PPC__) || defined(__s390__) || (defined(__arm__) && defined(__ARMEB__)) ||     \
	defined(__sparc__) || defined(__MIPSEB__) || defined(__m68k__) || defined(__hppa__) || \
...
static inline int io_getevents(io_context_t ctx_id, long min_nr, long nr, struct io_event *events,
